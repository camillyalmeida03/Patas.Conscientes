...
export class CriarElementos {
  ...
  // Método responsável por otimizar a criação de elementos OPTION
  // Recebe classes, value, texto interno, selected e elemento pai
  createOption(classes = [], value = "", innerText = "", selected = false, parent = null, id = "") {
    const option = document.createElement("option");

    if (id) option.id = id; // Adiciona o id se fornecido
