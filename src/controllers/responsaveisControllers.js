...
// Controller responsável por receber requisições HTTP e chamar o service da tabela responsaveis para executar o CRUD.

const model = require("../models/responsaveisServices");

const responsaveisControllers = {
...
module.exports = responsaveisControllers;