...
//         olhoIcon.src = isPassword ? "img/icons/olhoaberto.svg" : "img/icons/olhofechado.svg";
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (togglePassword && senhaInput && olhoIcon) {
        togglePassword.addEventListener("click", function () {
            ...
            if (type === "password") {
                olhoIcon.src = "img/icons/olhofechado.svg";
                olhoIcon.title = "Mostrar senha";
            } else {
                olhoIcon.src = "img/icons/olhoaberto.svg"; // Certifique-se que este ícone existe
