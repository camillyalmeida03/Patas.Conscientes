...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21/11/2025 às 16:05
...
(1, 'Ong Teste Um', '$2b$10$DyWp/MuoZXw', '(11) 11111-111', 'aaaaaaaaaa', NULL, NULL, 2, NULL, NULL, 'ongteste1@email.com', '$2b$10$PyvilVgVVykF6bgckmniYOGbEmeyMR2eeG4G0quRJ.ZYrC6XFTHTq', '2025-11-21 12:01:49', '2025-11-21 12:01:49', 4, 0, 0);
...
(3, 'Teste Usuario um', 'usuario1@email.com', '(11) 11111-1111', 1, '1994-07-14', '$2b$10$S02SSPI', '$2b$10$4o6jX78La0jenfBhJjdG9uyEIXJ0f6MGbrXO.nVD6Gskljh6ty5N2', '2025-11-21 12:00:26', '2025-11-21 12:00:26', NULL, 2, 3);
...
--
ALTER TABLE `ruas`
  MODIFY `idrua` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `sexo`
--
ALTER TABLE `sexo`
  MODIFY `idsexo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
